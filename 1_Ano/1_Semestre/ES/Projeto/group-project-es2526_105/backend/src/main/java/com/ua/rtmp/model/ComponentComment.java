...
public class ComponentComment {
    ...
    @JsonIgnore
    private ComponentComment parentComment;
    ...
    public void addReply(ComponentComment reply) {
        replies.add(reply);
        reply.setParentComment(this);
    }

    public void removeReply(ComponentComment reply) {
